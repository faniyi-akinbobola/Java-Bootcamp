...
//         }
        ...
        /**
         * function name: draw-draws an animal based on choice
         * @param choice (int)
         * 
         * if choice ==1; draws a butterfly
         * if choice ==2; draws an elephant
         * if choice ==3; draws a bear
         * if choice ==4; draws a snake
         */
